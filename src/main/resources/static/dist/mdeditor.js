(window.CodeMirror = (function () {
    ...
    function e(r, n) {
        ...
        (l.wrapper.CodeMirror = this),
            u(this),
        n.autofocus && !Wi && dt(this),
            (this.state = { keyMaps: [], overlays: [], modeGen: 0, overwrite: !1, focused: !1, suppressEdits: !1, pasteIncoming: !1, draggingText: !1, highlight: new Gn() }),
            s(this),
        ...
        c || (n.autofocus && !Wi) ? setTimeout(ei(Ft, this), 20) : Dt(this),
            ot(this, function () {
    ...
    function t(e, t) {
        ...
        return (
            Ti ? (n.style.width = "1000px") : n.setAttribute("wrap", "off"),
            Hi && (n.style.border = "1px solid black"),
                ...
                (r.heightForcer = ni("div", null, null, "position: absolute; height: " + Co + "px; width: 1px;")),
    ...
    function n(e) {
        e.options.lineWrapping ? ((e.display.wrapper.className += " CodeMirror-wrap"), (e.display.sizer.style.minWidth = "")) : ((e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-wrap", "")), h(e)),
            o(e),
            at(e),
            G(e),
            setTimeout(function () {
    ...
    function d(e) {
        ...
        l
            ? ((t.scrollbarV.style.display = "block"), (t.scrollbarV.style.bottom = o ? ui(t.measure) + "px" : "0"), (t.scrollbarV.firstChild.style.height = i - t.scroller.clientHeight + t.scrollbarV.clientHeight + "px"))
            : (t.scrollbarV.style.display = ""),
            o
                ? ((t.scrollbarH.style.display = "block"),
                    (t.scrollbarH.style.right = l ? ui(t.measure) + "px" : "0"),
                    (t.scrollbarH.firstChild.style.width = t.scroller.scrollWidth - t.scroller.clientWidth + t.scrollbarH.clientWidth + "px"))
                : (t.scrollbarH.style.display = ""),
            o && l ? ((t.scrollbarFiller.style.display = "block"), (t.scrollbarFiller.style.height = t.scrollbarFiller.style.width = ui(t.measure) + "px")) : (t.scrollbarFiller.style.display = ""),
            o && e.options.coverGutterNextToScrollbar && e.options.fixedGutter
                ? ((t.gutterFiller.style.display = "block"), (t.gutterFiller.style.height = ui(t.measure) + "px"), (t.gutterFiller.style.width = t.gutters.offsetWidth + "px"))
                : (t.gutterFiller.style.display = ""),
        Ni && 0 === ui(t.measure) && (t.scrollbarV.style.minWidth = t.scrollbarH.style.minHeight = zi ? "18px" : "12px");
    }
    function p(e, t, r) {
    ...
    function m(e) {
        ...
        if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
            for (var r = y(t) - t.scroller.scrollLeft + e.doc.scrollLeft, n = t.gutters.offsetWidth, i = r + "px", o = t.lineDiv.firstChild; o; o = o.nextSibling)
                if (o.alignable) for (var l = 0, s = o.alignable; l < s.length; ++l) s[l].style.left = i;
    ...
    function b(e, t, r, n) {
        for (
            var i, o = e.display.showingFrom, l = e.display.showingTo, s = p(e.display, e.doc, r);
            x(e, t, s, n) &&
            ((n = !1),
                (i = !0),
                E(e),
            ...
            r && (r = Math.min(e.display.scroller.scrollHeight - e.display.scroller.clientHeight, "number" == typeof r ? r : r.top)),
                (s = p(e.display, e.doc, r)),
                !(s.from >= e.display.showingFrom && s.to <= e.display.showingTo));
    ...
    function x(e, t, r, n) {
        ...
        if (!(!n && 0 == t.length && r.from > i.showingFrom && r.to < i.showingTo)) {
            ...
            0.7 * (h - c) > v && (i.lineDiv.style.display = "none"), S(e, c, h, f, s), (i.lineDiv.style.display = ""), y && document.activeElement != y && y.offsetHeight && y.focus();
    ...
    function C(e, t) {
        for (var r = 0, n = t.length || 0; n > r; ++r) {
            for (var i = t[r], o = [], l = i.diff || 0, s = 0, a = e.length; a > s; ++s) {
                var u = e[s];
                i.to <= u.from && i.diff
                    ? o.push({ from: u.from + l, to: u.to + l })
                    : i.to <= u.from || i.from >= u.to
                    ? o.push(u)
                    : (i.from > u.from && o.push({ from: u.from, to: i.from }), i.to < u.to && o.push({ from: i.to + l, to: u.to + l }));
            }
            e = o;
        }
        return e;
    ...
    function L(e) {
        ...
        return { fixedPos: y(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: r, gutterWidth: n, wrapperWidth: t.wrapper.clientWidth };
    }
    ...
    function M(e, t, r, n, i) {
        ...
        if ((o || ((o = ni("div", null, t.wrapClass, "position: relative")), o.appendChild(l)), t.bgClass && o.insertBefore(ni("div", null, t.bgClass + " CodeMirror-linebackground"), o.firstChild), e.options.lineNumbers || s)) {
            ...
            if (
                (e.options.fixedGutter && (o.alignable || (o.alignable = [])).push(g),
                !e.options.lineNumbers ||
                (s && s["CodeMirror-linenumbers"]) ||
                (o.lineNumber = g.appendChild(ni("div", v(e.options, r), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + n.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + a.lineNumInnerWidth + "px"))),
                    s)
            )
    ...
    function A(e) {
        ...
        (t.cursor.style.left = r.left + "px"),
            ...
            r.other
                ? ((t.otherCursor.style.display = ""), (t.otherCursor.style.left = r.other.left + "px"), (t.otherCursor.style.top = r.other.top + "px"), (t.otherCursor.style.height = 0.85 * (r.other.bottom - r.other.top) + "px"))
    ...
    function _(e) {
        ...
        function r(r, n, o) {
            ...
            var u,
                ...
                f = h.text.length;
            return (
                hi(yn(h), n || 0, null == o ? f : o, function (e, r, i) {
                    var h,
                        d,
                        p,
                        m = l(e, "left");
                    ...
                    null == n && 0 == e && (d = a),
                    h.top - m.top > 3 && (t(d, m.top, null, m.bottom), (d = a), m.bottom < h.top && t(d, m.bottom, null, h.top)),
                    null == o && r == f && (p = s),
                    (!u || m.top < u.top || (m.top == u.top && m.left < u.left)) && (u = m),
                    (!c || h.bottom > c.bottom || (h.bottom == c.bottom && h.right > c.right)) && (c = h),
                    a + 1 > d && (d = a),
                        t(d, h.top, p - d, h.bottom);
                }),
                    { start: u, end: c }
            );
        }
        ...
        if ((t.frontier < t.first && (t.frontier = t.first), !(t.frontier >= e.display.showingTo))) {
            ...
            t.iter(t.frontier, Math.min(t.first + t.size, e.display.showingTo + 500), function (l) {
                if (t.frontier >= e.display.showingFrom) {
                    ...
                    a && (r && r.end == t.frontier ? r.end++ : o.push((r = { start: t.frontier, end: t.frontier + 1 }))), (l.stateAfter = gr(t.mode, i));
    ...
    function $(e, t) {
        ...
        var n = j(e, t),
            ...
            o = { text: t.text, width: e.display.scroller.clientWidth, markedSpans: t.markedSpans, measure: n, classes: t.textClass + "|" + t.bgClass + "|" + t.wrapClass };
    ...
    function j(e, t) {
        function r(e) {
            ...
            return 0 > n && ((n = m.length), m.push(t, r)), { left: e.left - p.left, right: e.right - p.left, top: n, bottom: null };
        }
        function n(e) {
    ...
    function Y(e, t, r, n, i) {
        ...
        function l(e, t) {
            var r = s[t],
                n = r.level % 2;
            return (
                e == fi(r) && t && r.level < s[t - 1].level
                    ? ((r = s[--t]), (e = di(r) - (r.level % 2 ? 0 : 1)), (n = !0))
                    : e == di(r) && t < s.length - 1 && r.level < s[t + 1].level && ((r = s[++t]), (e = fi(r) - (r.level % 2)), (n = !1)),
    ...
    function nt(e) {
        (e.curOp = { changes: [], forceUpdate: !1, updateInput: null, userSelChange: null, textChanged: null, selectionChanged: !1, cursorActivity: !1, updateMaxLine: !1, updateScrollPos: !1, id: ++Ki }), ko++ || (wo = []);
    }
    function it(e) {
        var t = e.curOp,
            r = e.doc,
        ...
        !s && t.selectionChanged && E(e),
            t.updateScrollPos
                ? ((n.scroller.scrollTop = n.scrollbarV.scrollTop = r.scrollTop = l.scrollTop),
                    (n.scroller.scrollLeft = n.scrollbarH.scrollLeft = r.scrollLeft = l.scrollLeft),
                    m(e),
                t.scrollToPos && ir(e, Qt(e.doc, t.scrollToPos), t.scrollToPosMargin))
                : l && nr(e),
        t.selectionChanged && F(e),
        e.state.focused && t.updateInput && ft(e, t.userSelChange);
    ...
    function at(e, t, r, n) {
        null == t && (t = e.doc.first), null == r && (r = e.doc.first + e.doc.size), e.curOp.changes.push({ from: t, to: r, diff: n });
    }
    function ut(e) {
    ...
    function mt(e) {
        ...
        var l = e.display;
        Wn(l.scroller, "mousedown", ot(e, yt)),
            Li
                ? Wn(
                l.scroller,
                "dblclick",
        ...
        Gi ||
        Wn(l.scroller, "contextmenu", function (t) {
            Nt(e, t);
        }),
            ...
            Wn(l.scrollbarH, "mousedown", t),
            Wn(l.scrollbarV, "mousedown", t),
            Wn(l.wrapper, "scroll", function () {
        ...
        Wn(window, "resize", r),
            ...
            Wn(l.input, "input", ei(ct, e)),
            Wn(l.input, "keydown", ot(e, At)),
            Wn(l.input, "keypress", ot(e, _t)),
            Wn(l.input, "focus", ei(Ft, e)),
            Wn(l.input, "blur", ei(Dt, e)),
        e.options.dragDrop &&
        (Wn(l.scroller, "dragstart", function (t) {
            wt(e, t);
        }),
            Wn(l.scroller, "dragenter", i),
            Wn(l.scroller, "dragover", i),
            Wn(l.scroller, "drop", ot(e, xt))),
            Wn(l.scroller, "paste", function (t) {
                gt(l, t) || (dt(e), ct(e));
            }),
                ...
                if (i.options.dragDrop && Eo && !pt(i) && !Gt(s.from, s.to) && !qt(a, s.from) && !qt(s.to, a) && "single" == c) {
                    var d = ot(i, function (t) {
                        Ti && (o.scroller.draggable = !1),
                            ...
                            In(document, "mouseup", d),
                            In(o.scroller, "drop", d),
                        Math.abs(e.clientX - t.clientX) + Math.abs(e.clientY - t.clientY) < 10 && (Fn(t), Zt(i.doc, a), dt(i));
                    });
                    ...
                    for (
                        var i = n.length,
                            ...
                            s = function (e, n) {
                                ...
                                (s.onload = function () {
                                    (o[n] = s.result), ++l == i && ((r = Qt(t.doc, r)), Wt(t.doc, { from: r, to: r, text: Fo(o.join("\n")), origin: "paste" }, "around"));
                                }),
                                    s.readAsText(e);
                            },
                            a = 0;
    ...
    function kt(e, t) {
        ...
        ((e.doc.scrollTop = t), Ci || b(e, [], t), e.display.scroller.scrollTop != t && (e.display.scroller.scrollTop = t), e.display.scrollbarV.scrollTop != t && (e.display.scrollbarV.scrollTop = t), Ci && b(e, []), D(e, 100));
    }
    function Ct(e, t, r) {
    ...
    function Lt(e, t) {
        ...
        if ((r && o.scrollWidth > o.clientWidth) || (n && o.scrollHeight > o.clientHeight)) {
            ...
            if (r && !Ci && !_i && null != Yi)
                return n && kt(e, Math.max(0, Math.min(o.scrollTop + n * Yi, o.scrollHeight - o.clientHeight))), Ct(e, Math.max(0, Math.min(o.scrollLeft + r * Yi, o.scrollWidth - o.clientWidth))), Fn(t), (i.wheelStartX = null), void 0;
            if (n && null != Yi) {
                var s = n * Yi,
                    a = e.doc.scrollTop,
    ...
    function Tt(e, t) {
        ...
        return (
            ...
            o && (Fn(t), F(e), Mi && ((t.oldKeyCode = t.keyCode), (t.keyCode = 0)), Rn(e, "keyHandled", e, i, t)),
                o
        );
    }
    function Et(e, t, r) {
    ...
    function _t(e) {
        ...
        if (!(Bn(t, e) || (t.options.onKeyEvent && t.options.onKeyEvent(t, _n(e))))) {
            ...
            if (!((_i && (!e.which || e.which < 10)) || Di) || !Tt(t, e)) {
                ...
                !pt(this) &&
                this.doc.mode.electricChars.indexOf(i) > -1 &&
                setTimeout(
                    ot(t, function () {
                ...
                Et(t, e, i) || (Li && !Mi && (t.display.inputHasSelection = null), ct(t));
            }
        }
    }
    function Ft(e) {
        "nocursor" != e.options.readOnly &&
        (e.state.focused || (Pn(e, "focus", e), (e.state.focused = !0), -1 == e.display.wrapper.className.search(/\bCodeMirror-focused\b/) && (e.display.wrapper.className += " CodeMirror-focused"), ft(e, !0)), ut(e), F(e));
    }
    function Dt(e) {
        e.state.focused && (Pn(e, "blur", e), (e.state.focused = !1), (e.display.wrapper.className = e.display.wrapper.className.replace(" CodeMirror-focused", ""))),
                ...
                if (l && !_i) {
                    ...
                    if (
                        ((i.inputDiv.style.position = "absolute"),
                            ...
                            dt(e),
                            ft(e, !0),
                        Gt(o.from, o.to) && (i.input.value = i.prevInput = " "),
                        Li && !Mi && r(),
                            Gi)
                    ) {
                        zn(t);
    ...
    function Ht(e, t, r) {
        ...
        return (
            ...
            (n.update = function (t, r, n, i) {
                ...
                Pn(e, "beforeChange", e, n),
            e.cm && Pn(e.cm, "beforeChange", e.cm, n),
    ...
    function Pt(e, t) {
        if (!e.cm || !e.cm.state.suppressEdits) {
            ...
            if (n) {
                var i = { changes: [], anchorBefore: n.anchorAfter, headBefore: n.headAfter, anchorAfter: n.anchorBefore, headAfter: n.headBefore, generation: r.generation };
    ...
    function Bt(e, t, r, n) {
        ...
        if (!(t.from.line > e.lastLine())) {
            if (t.from.line < e.first) {
                ...
                Rt(e, i), (t = { from: Ut(e.first, 0), to: Ut(t.to.line + i, t.to.ch), text: [Kn(t.text)], origin: t.origin });
            }
            var o = e.lastLine();
    ...
    function sr(e, t, r) {
        e.curOp.updateScrollPos = { scrollLeft: null == t ? e.doc.scrollLeft : t, scrollTop: null == r ? e.doc.scrollTop : r };
    }
    function ar(e, t, r) {
        var n = e.curOp.updateScrollPos || (e.curOp.updateScrollPos = { scrollLeft: e.doc.scrollLeft, scrollTop: e.doc.scrollTop }),
    ...
    function fr(e, t, r, n) {
        ...
        if ("page" == n) {
            ...
            i = t.top + r * (s - (0 > r ? 1.5 : 0.5) * tt(e.display));
    ...
    function Lr(e, t, r, n, i) {
        ...
        o.collapsed && (Vi = !0),
        o.addToHistory && kn(e, { from: t, to: r, origin: "markText" }, { head: e.sel.head, anchor: e.sel.anchor }, 0 / 0);
        var l,
            s,
            a,
            u = t.line,
        ...
        if (
            (e.iter(u, r.line + 1, function (n) {
                ...
                o.collapsed && (u == r.line && (s = Or(n, r.ch)), u == t.line ? (l = Or(n, t.ch)) : pn(n, 0)),
                    Ar(n, i),
                    ++u;
            }),
            o.collapsed &&
            ...
            o.clearOnEnter &&
            Wn(o, "beforeCursorEnter", function () {
                o.clear();
            }),
            o.readOnly && ((qi = !0), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
                o.collapsed)
        ) {
    ...
    function Dr(e, t) {
        ...
        if (!u) {
            var m,
                g = t.text.length - 2;
            if (g > 0 && s) for (var h = 0; h < s.length; ++h) null == s[h].to && (m || (m = [])).push({ from: null, to: null, marker: s[h].marker });
        ...
        for (var i = [{ from: t, to: r }], o = 0; o < n.length; ++o)
            for (var l = n[o], s = l.find(), a = 0; a < i.length; ++a) {
                ...
                if (!qt(u.to, s.from) && !qt(s.to, u.from)) {
                    var c = [a, 1];
                    (qt(u.from, s.from) || (!l.inclusiveLeft && Gt(u.from, s.from))) && c.push({ from: u.from, to: s.from }),
                    (qt(s.to, u.to) || (!l.inclusiveRight && Gt(u.to, s.to))) && c.push({ from: s.to, to: u.to }),
                        i.splice.apply(i, c),
                        (a += c.length - 1);
                }
            }
    ...
    function Kr(e, t, r, n, i) {
        ...
        for ("" == t && r.blankLine && r.blankLine(n); !u.eol(); )
                ...
                if (g == d) {
                    ...
                    for (var v = null, y = 0; y < n.length; ++y) {
                        ...
                        b.from <= d && (null == b.to || b.to > d)
                            ? (null != b.to && g > b.to && ((g = b.to), (a = "")),
                            x.className && (s += " " + x.className),
                            x.startStyle && b.from == d && (u += " " + x.startStyle),
                            x.endStyle && b.to == g && (a += " " + x.endStyle),
                            x.title && !c && (c = x.title),
                            x.collapsed && (!h || h.marker.size < x.size) && (h = b))
                            : b.from > d && g > b.from && (g = b.from),
    ...
    function bn(e) {
        return { done: [], undone: [], undoDepth: 1 / 0, lastTime: 0, lastOp: null, lastOrigin: null, generation: e || 1, maxGeneration: e || 1 };
    }
    function xn(e, t, r, n) {
        var i = t["spans_" + e.id],
            o = 0;
    ...
    function wn(e, t) {
        var r = { line: t.from.line, ch: t.from.ch },
            n = { from: r, to: to(t), text: fn(e, t.from, t.to) };
        return (
    ...
    function kn(e, t, r, n) {
        ...
        if (l && (i.lastOp == n || (i.lastOrigin == t.origin && t.origin && (("+" == t.origin.charAt(0) && e.cm && i.lastTime > o - e.cm.options.historyEventDelay) || "*" == t.origin.charAt(0))))) {
            ...
            for (
                l = { changes: [wn(e, t)], generation: i.generation, anchorBefore: e.sel.anchor, headBefore: e.sel.head, anchorAfter: r.anchor, headAfter: r.head }, i.done.push(l), i.generation = ++i.maxGeneration;
    ...
    function Sn(e, t) {
        for (var r = 0, n = []; r < e.length; ++r) {
            var i = e[r],
                o = i.changes,
                l = [];
            n.push({ changes: l, anchorBefore: i.anchorBefore, headBefore: i.headBefore, anchorAfter: i.anchorAfter, headAfter: i.headAfter });
            for (var s = 0; s < o.length; ++s) {
                var a,
                    u = o[s];
                if ((l.push({ from: u.from, to: u.to, text: u.text }), t)) for (var c in u) (a = c.match(/^spans_(\d+)$/)) && Xn(t, Number(a[1])) > -1 && ((Kn(l)[c] = u[c]), delete u[c]);
            }
        }
        return n;
    }
    ...
    function Tn(e, t, r, n) {
        for (var i = 0; i < e.length; ++i) {
            ...
            o.copied || ((o.anchorBefore = Vt(o.anchorBefore)), (o.headBefore = Vt(o.headBefore)), (o.anchorAfter = Vt(o.anchorAfter)), (o.readAfter = Vt(o.headAfter)), (o.copied = !0)),
    ...
    var Bi,
        ...
        Xi = 0,
        Yi = null;
    Li ? (Yi = -0.53) : Ci ? (Yi = 15) : Ai ? (Yi = -0.7) : Fi && (Yi = -1 / 3);
    var Zi,
        Ji,
        eo = null,
    ...
    (e.Pos = Ut),
        (e.prototype = {
            ...
            addWidget: function (e, t, r, n, i) {
                ...
                r && or(this, s, l, s + t.offsetWidth, l + t.offsetHeight);
            },
    ...
    mr(
        ...
        mr("showCursorWhenSelecting", !1, E, !0),
        mr("readOnly", !1, function (e, t) {
        ...
        mr("moveInputWithCursor", !0, function (e, t) {
    ...
    (ho.basic = {
        ...
        (ho["default"] = Ii ? ho.macDefault : ho.pcDefault),
        (ho.emacsy = {
            "Ctrl-F": "goCharRight",
            "Ctrl-B": "goCharLeft",
            "Ctrl-P": "goLineUp",
    ...
    Un(fo),
        (fo.prototype.clear = jr(function () {
    ...
    var vo = 0,
        yo = (e.Doc = function (e, t, r) {
            ...
            var n = Ut(r, 0);
            (this.sel = { from: n, to: n, head: n, anchor: n, shift: !1, extend: !1, goalColumn: null }),
                (this.id = ++vo),
                (this.modeOption = t),
            "string" == typeof e && (e = Fo(e)),
                ln(this, { from: n, to: n, text: e }, null, { head: n, anchor: n });
        });
    (yo.prototype = Yn(an.prototype, {
        ...
        setValue: function (e) {
            ...
            Wt(this, { from: t, to: Ut(r, hn(this, r).text.length), text: Fo(e), origin: "setValue" }, { head: t, anchor: t }, !0);
        },
        ...
        copy: function (e) {
            ...
            return (
                (t.scrollTop = this.scrollTop),
                    ...
                    (t.sel = { from: this.sel.from, to: this.sel.to, head: this.sel.head, anchor: this.sel.anchor, shift: this.sel.shift, extend: !1, goalColumn: this.sel.goalColumn }),
        ...
        linkedDoc: function (e) {
            ...
            return e.sharedHist && (n.history = this.history), (this.linked || (this.linked = [])).push({ doc: n, sharedHist: e.sharedHist }), (n.linked = [{ doc: this, isParent: !0, sharedHist: e.sharedHist }]), n;
        },
    ...
    for (var xo in yo.prototype)
        yo.prototype.hasOwnProperty(xo) &&
        Xn(bo, xo) < 0 &&
    ...
    Ci
        ...
        : Fi && !/Version\/([6-9]|\d\d)\b/.test(navigator.userAgent)
        ? (ai = function (e, t) {
    ...
    var Oo,
        Ho = (function () {
            ...
            return function (t) {
                ...
                return (
                    1 == x[0].level && (b = t.match(/^\s+/)) && ((x[0].from = b[0].length), x.unshift({ from: 0, to: b[0].length, level: 0 })),
                    1 == Kn(x).level && (b = t.match(/\s+$/)) && ((Kn(x).to -= b[0].length), x.push({ from: u - b[0].length, to: u, level: 0 })),
                    x[0].level != Kn(x).level && x.push({ from: u, to: u, level: x[0].level }),
                        x
                );
            };
        })();
        ...
        function (e, t) {
            ...
            var g = CodeMirror.mimeModes.hasOwnProperty("text/html"),
                ...
                b = (function () {
                    ...
                    var s = [];
                    for (var l in CodeMirror.mimeModes) CodeMirror.mimeModes.propertyIsEnumerable(l) && s.push({ mime: l, mode: CodeMirror.mimeModes[l] });
            ...
            return {
                startState: function () {
                    return (w = !1), (k = !1), { f: o, block: o, htmlState: CodeMirror.startState(v), indentation: 0, inline: c, text: u, linkText: !1, linkTitle: !1, em: !1, strong: !1, header: !1, list: !1, quote: !1 };
                },
    ...
    function () {
        ...
        (d.iteratee = function (e, t, r) {
            ...
            (d.each = d.forEach = function (e, t, r) {
                ...
                var n,
                    i = e.length;
                if (i === +i) for (n = 0; i > n; n++) t(e[n], n, e);
                else {
                    var o = d.keys(e);
    ...
    function () {
        ...
        function t(e, t) {
            if (((this.options = t || u.defaults), (this.links = e), (this.rules = h.normal), (this.renderer = this.options.renderer || new r()), (this.renderer.options = this.options), !this.links))
        ...
        (c.bullet = /(?:[*+-]|\d+\.)/),
            (c.item = /^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/),
            (c.item = l(c.item, "gm")(/bull/g, c.bullet)()),
            (c.list = l(c.list)(/bull/g, c.bullet)("hr", "\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))")("def", "\\n+(?=" + c.def.source + ")")()),
            (c.blockquote = l(c.blockquote)("def", c.def)()),
            ...
            (c.html = l(c.html)("comment", /<!--[\s\S]*?-->/)("closed", /<(tag)[\s\S]+?<\/\1>/)("closing", /<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g, c._tag)()),
            (c.paragraph = l(c.paragraph)("hr", c.hr)("heading", c.heading)("lheading", c.lheading)("blockquote", c.blockquote)("tag", "<" + c._tag)("def", c.def)()),
            (c.normal = a({}, c)),
            (c.gfm = a({}, c.normal, { fences: /^ *(`{3,}|~{3,}) *(\S+)? *\n([\s\S]+?)\s*\1 *(?:\n+|$)/, paragraph: /^/ })),
            (c.gfm.paragraph = l(c.paragraph)("(?!", "(?!" + c.gfm.fences.source.replace("\\1", "\\2") + "|" + c.list.source.replace("\\1", "\\3") + "|")()),
            (c.tables = a({}, c.gfm, { nptable: /^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/, table: /^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/ })),
            (e.rules = c),
            (e.lex = function (t, r) {
                var n = new e(r);
                return n.lex(t);
                ...
                for (var n, i, o, l, s, a, u, h, f, e = e.replace(/^ +$/gm, ""); e; )
                    if (((o = this.rules.newline.exec(e)) && ((e = e.substring(o[0].length)), o[0].length > 1 && this.tokens.push({ type: "space" })), (o = this.rules.code.exec(e))))
                        ...
                        for (
                            ...
                            a.align[h] = /^ *-+: *$/.test(a.align[h]) ? "right" : /^ *:-+: *$/.test(a.align[h]) ? "center" : /^ *:-+ *$/.test(a.align[h]) ? "left" : null;
                        ...
                        for (e = e.substring(o[0].length), l = o[2], this.tokens.push({ type: "list_start", ordered: l.length > 1 }), o = o[0].match(this.rules.item), n = !1, f = o.length, h = 0; f > h; h++)
                            (a = o[h]),
                                (u = a.length),
                                (a = a.replace(/^ *([*+-]|\d+\.) +/, "")),
                            ~a.indexOf("\n ") && ((u -= a.length), (a = this.options.pedantic ? a.replace(/^ {1,4}/gm, "") : a.replace(new RegExp("^ {1," + u + "}", "gm"), ""))),
                            this.options.smartLists && h !== f - 1 && ((s = c.bullet.exec(o[h + 1])[0]), l === s || (l.length > 1 && s.length > 1) || ((e = o.slice(h + 1).join("\n") + e), (h = f - 1))),
                                (i = n || /\n\n(?!\s*$)/.test(a)),
                        ...
                        (e = e.substring(o[0].length)), this.tokens.push({ type: this.options.sanitize ? "paragraph" : "html", pre: "pre" === o[1] || "script" === o[1] || "style" === o[1], text: o[0] });
        ...
        (h._inside = /(?:\[[^\]]*\]|[^\[\]]|\](?=[^\[]*\]))*/),
            ...
            (h.link = l(h.link)("inside", h._inside)("href", h._href)()),
            (h.reflink = l(h.reflink)("inside", h._inside)()),
            (h.normal = a({}, h)),
            (h.pedantic = a({}, h.normal, { strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/, em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/ })),
            (h.gfm = a({}, h.normal, { escape: l(h.escape)("])", "~|])")(), url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, del: /^~~(?=\S)([\s\S]*?\S)~~/, text: l(h.text)("]|", "~]|")("|", "|https?://|")() })),
            (h.breaks = a({}, h.gfm, { br: l(h.br)("{2,}", "*")(), text: l(h.gfm.text)("{2,}", "*")() })),
            (t.rules = h),
            (t.output = function (e, r, n) {
                var i = new t(r, n);
                return i.output(e);
            }),
            (t.prototype.output = function (e) {
                for (var t, r, n, o, l = ""; e; )
                    if ((o = this.rules.escape.exec(e))) (e = e.substring(o[0].length)), (l += o[1]);
                        ...
                        (e = e.substring(o[0].length)),
                            "@" === o[2] ? ((r = ":" === o[1].charAt(6) ? this.mangle(o[1].substring(7)) : this.mangle(o[1])), (n = this.mangle("mailto:") + r)) : ((r = i(o[1])), (n = r)),
                            (l += this.renderer.link(n, null, r));
                    else if (this.inLink || !(o = this.rules.url.exec(e))) {
                        if ((o = this.rules.tag.exec(e)))
                            !this.inLink && /^<a /i.test(o[0]) ? (this.inLink = !0) : this.inLink && /^<\/a>/i.test(o[0]) && (this.inLink = !1), (e = e.substring(o[0].length)), (l += this.options.sanitize ? i(o[0]) : o[0]);
            ...
            (t.prototype.mangle = function (e) {
                for (var t, r = "", n = e.length, i = 0; n > i; i++) (t = e.charCodeAt(i)), Math.random() > 0.5 && (t = "x" + t.toString(16)), (r += "&#" + t + ";");
                return r;
            }),
                ...
                switch (this.token.type) {
                    ...
                    case "table":
                        ...
                        for (r = "", e = 0; e < this.token.header.length; e++)
                            (n = { header: !0, align: this.token.align[e] }), (r += this.renderer.tablecell(this.inline.output(this.token.header[e]), { header: !0, align: this.token.align[e] }));
            ...
            (u.defaults = { gfm: !0, tables: !0, breaks: !1, pedantic: !1, sanitize: !1, smartLists: !1, silent: !1, highlight: null, langPrefix: "lang-", smartypants: !1, headerPrefix: "", renderer: new r(), xhtml: !1 }),
            (u.Parser = n),
            (u.parser = n.parse),
            (u.Renderer = r),
            (u.Lexer = e),
            ...
            e.register("dropzone/lib/dropzone.js", function (t, r) {
                (function () {
                    ...
                    (n = "undefined" != typeof Emitter && null !== Emitter ? Emitter : e("component~emitter@1.1.2")),
                            ...
                            function t(e, n) {
                                ...
                                if (
                                    (t.instances.push(this),
                                        ...
                                        (i = null != (l = t.optionsForElement(this.element)) ? l : {}),
                                ...
                                this.options.previewsContainer !== !1 && (this.previewsContainer = this.options.previewsContainer ? t.getElement(this.options.previewsContainer, "previewsContainer") : this.element),
                                this.options.clickable && (this.clickableElements = this.options.clickable === !0 ? [this.element] : t.getElements(this.options.clickable, "clickable")),
                                    this.init();
                            }
                            var r;
                            return (
                                h(t, e),
                                    ...
                                    (t.prototype.defaultOptions = {
                                        ...
                                        fallback: function () {
                                            var e, r, n, i, o, l;
                                            for (this.element.className = "" + this.element.className + " dz-browser-not-supported", l = this.element.getElementsByTagName("div"), i = 0, o = l.length; o > i; i++)
                                                (e = l[i]), /(^| )dz-message($| )/.test(e.className) && ((r = e), (e.className = "dz-message"));
                                            return (
                                                r || ((r = t.createElement('<div class="dz-message"><span></span></div>')), this.element.appendChild(r)),
                                                    (n = r.getElementsByTagName("span")[0]),
                                            ...
                                            return (
                                                (t = { srcX: 0, srcY: 0, srcWidth: e.width, srcHeight: e.height }),
                                                    ...
                                                    null == t.optWidth && null == t.optHeight
                                                        ...
                                                        : null == t.optWidth
                                                        ? (t.optWidth = r * t.optHeight)
                                                        : null == t.optHeight && (t.optHeight = (1 / r) * t.optWidth),
                                            ...
                                            if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer)) {
                                                for (
                                                    e.previewElement = t.createElement(this.options.previewTemplate.trim()),
                                                        ...
                                                        h = e.previewElement.querySelectorAll("[data-dz-name]"),
                                                        o = 0,
                                                        a = h.length;
                                                    a > o;
                                                    o++
                                                )
                                                    (r = h[o]), (r.textContent = e.name);
                                                for (f = e.previewElement.querySelectorAll("[data-dz-size]"), l = 0, u = f.length; u > l; l++) (r = f[l]), (r.innerHTML = this.filesize(e.size));
                                                for (
                                                    this.options.addRemoveLinks &&
                                                    ((e._removeLink = t.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>")),
                                                                ...
                                                                return (
                                                                    n.preventDefault(),
                                                                        ...
                                                                        e.status === t.UPLOADING
                                                                            ? t.confirm(r.options.dictCancelUploadConfirmation, function () {
                                                                                return r.removeFile(e);
                                                                            })
                                                                            : r.options.dictRemoveFileConfirmation
                                                                            ? t.confirm(r.options.dictRemoveFileConfirmation, function () {
                                                                                return r.removeFile(e);
                                                                            })
                                                                            : r.removeFile(e)
                                                                );
                                                        ...
                                                        d = e.previewElement.querySelectorAll("[data-dz-remove]"),
                                                        p = [],
                                                        s = 0,
                                                        c = d.length;
                                                    c > s;
                                                    ...
                                                    (i = d[s]), p.push(i.addEventListener("click", n));
                                                return p;
                                            }
                                        },
                                        ...
                                        thumbnail: function (e, t) {
                                            ...
                                            if (e.previewElement) {
                                                for (
                                                    ...
                                                    (r = o[n]), (r.alt = e.name), l.push((r.src = t));
                                                return l;
                                            }
                                        },
                                        error: function (e, t) {
                                            ...
                                            if (e.previewElement) {
                                                for (
                                                    e.previewElement.classList.add("dz-error"), "String" != typeof t && t.error && (t = t.error), o = e.previewElement.querySelectorAll("[data-dz-errormessage]"), l = [], n = 0, i = o.length;
                                                    i > n;
                                                    n++
                                                )
                                                    (r = o[n]), l.push((r.textContent = t));
                                                return l;
                                            }
                                        },
                                        errormultiple: a,
                                        ...
                                        uploadprogress: function (e, t) {
                                            var r, n, i, o, l;
                                            if (e.previewElement) {
                                                for (o = e.previewElement.querySelectorAll("[data-dz-uploadprogress]"), l = [], n = 0, i = o.length; i > n; n++)
                                                    (r = o[n]), l.push("PROGRESS" === r.nodeName ? (r.value = t) : (r.style.width = "" + t + "%"));
                                                return l;
                                            }
                                        },
                                    ...
                                    (t.prototype.init = function () {
                                        ...
                                        for (
                                            ...
                                            (n = (function (e) {
                                                return function () {
                                                    return (
                                                        e.hiddenFileInput && document.body.removeChild(e.hiddenFileInput),
                                                ...
                                                this.URL = null != (l = window.URL) ? l : window.webkitURL,
                                                s = this.events,
                                                i = 0,
                                                o = s.length;
                                            o > i;
                                        ...
                                        return (
                                            this.on(
                                                ...
                                                this.on(
                                                    ...
                                                    (function (e) {
                                                        return function () {
                                                            return 0 === e.getUploadingFiles().length && 0 === e.getQueuedFiles().length
                                                                ? setTimeout(function () {
                                        ...
                                        return (e = this.getExistingFallback())
                                            ...
                                            this.options.dictFallbackText && (n += "<p>" + this.options.dictFallbackText + "</p>"),
                                                ...
                                                "FORM" !== this.element.tagName
                                                    ? ((i = t.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')), i.appendChild(r))
                                    ...
                                    (t.prototype.setupEventListeners = function () {
                                        var e, t, r, n, i, o, l;
                                        for (o = this.listeners, l = [], n = 0, i = o.length; i > n; n++)
                                            (e = o[n]),
                                                l.push(
                                                    (function () {
                                                        var n, i;
                                    ...
                                    (t.prototype.disable = function () {
                                        ...
                                        for (
                                            ...
                                            (e = n[t]), i.push(this.cancelUpload(e));
                                        return i;
                                    }),
                                    ...
                                    (t.prototype.drop = function (e) {
                                        var t, r;
                                        e.dataTransfer &&
                                        (this.emit("drop", e), (t = e.dataTransfer.files), t.length && ((r = e.dataTransfer.items), r && r.length && null != r[0].webkitGetAsEntry ? this._addFilesFromItems(r) : this.handleFiles(t)));
                                    }),
                                    ...
                                    (t.prototype._addFilesFromItems = function (e) {
                                        ...
                                        for (o = [], n = 0, i = e.length; i > n; n++)
                                            (r = e[n]),
                                                o.push(
                                                    null != r.webkitGetAsEntry && (t = r.webkitGetAsEntry())
                                                        ? t.isFile
                                                        ? this.addFile(r.getAsFile())
                                                        : t.isDirectory
                                    ...
                                    (t.prototype.accept = function (e, r) {
                                        return e.size > 1024 * this.options.maxFilesize * 1024
                                            ? r(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(e.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}", this.options.maxFilesize))
                                            : t.isValidFile(e, this.options.acceptedFiles)
                                                ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles
                                                    ? (r(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}", this.options.maxFiles)), this.emit("maxfilesexceeded", e))
                                                    : this.options.accept.call(this, e, r)
                                    ...
                                    (t.prototype._enqueueThumbnail = function (e) {
                                        return this.options.createImageThumbnails && e.type.match(/image.*/) && e.size <= 1024 * this.options.maxThumbnailFilesize * 1024
                                                ...
                                                (r.onload = (function (n) {
                                                    return function () {
                                                        ...
                                                        return "image/svg+xml" === e.type
                                                            ? (n.emit("thumbnail", e, r.result), void (null != t && t()))
                                                                ...
                                                                (i.onload = function () {
                                                                    ...
                                                                    return (
                                                                        ...
                                                                        null == l.trgHeight && (l.trgHeight = l.optHeight),
                                                                            ...
                                                                            (a = r.toDataURL("image/png")),
                                                                            n.emit("thumbnail", e, a),
                                                                            null != t ? t() : void 0
                                                                    );
                                                                }),
                                                                (i.src = r.result));
                                    ...
                                    (t.prototype.uploadFiles = function (e) {
                                        ...
                                        b.open(this.options.method, this.options.url, !0),
                                            ...
                                            (v = (function (t) {
                                                return function (r) {
                                                    ...
                                                    if (null != r) for (o = (100 * r.loaded) / r.total, l = 0, u = e.length; u > l; l++) (n = e[l]), (n.upload = { progress: o, total: r.total, bytesSent: r.loaded });
                                                    else {
                                                        for (i = !0, o = 100, s = 0, c = e.length; c > s; s++)
                                                            (n = e[s]), (100 !== n.upload.progress || n.upload.bytesSent !== n.upload.total) && (i = !1), (n.upload.progress = o), (n.upload.bytesSent = n.upload.total);
                                                        if (i) return;
                                                    }
                                            ...
                                            (b.onload = (function (r) {
                                                return function (n) {
                                                    ...
                                                    if (e[0].status !== t.CANCELED && 4 === b.readyState) {
                                                        if (((g = b.responseText), b.getResponseHeader("content-type") && ~b.getResponseHeader("content-type").indexOf("application/json")))
                                                            try {
                                                                g = JSON.parse(g);
                                                            } catch (l) {
                                            ...
                                            (m = null != (A = b.upload) ? A : b),
                                            (m.onprogress = v),
                                            (a = { Accept: "application/json", "Cache-Control": "no-cache", "X-Requested-With": "XMLHttpRequest" }),
                        ...
                        (t.discover = function () {
                            ...
                            for (
                                ...
                                (r = n[i]), l.push(t.optionsForElement(r) !== !1 ? new t(r) : void 0);
                            return l;
                        }),
                        ...
                        (t.isBrowserSupported = function () {
                            ...
                            if (((e = !0), window.File && window.FileReader && window.FileList && window.Blob && window.FormData && document.querySelector))
                                if ("classList" in document.createElement("a")) for (o = t.blacklistedBrowsers, n = 0, i = o.length; i > n; n++) (r = o[n]), r.test(navigator.userAgent) && (e = !1);
                                else e = !1;
                            else e = !1;
                            return e;
                        }),
                        ...
                        (t.getElement = function (e, t) {
                            var r;
                            if (("string" == typeof e ? (r = document.querySelector(e)) : null != e.nodeType && (r = e), null == r))
                        ...
                        (t.getElements = function (e, t) {
                            ...
                            } else if ("string" == typeof e) for (i = [], u = document.querySelectorAll(e), l = 0, a = u.length; a > l; l++) (n = u[l]), i.push(n);
                    ...
                    (jQuery.fn.dropzone = function (e) {
                        ...
                        "undefined" != typeof r && null !== r ? (r.exports = t) : (window.Dropzone = t),
                        (t.ADDED = "added"),
                        (t.QUEUED = "queued"),
                        (t.ACCEPTED = t.QUEUED),
                        ...
                        (l = function (e) {
                            ...
                            for (
                                ...
                                (t = i[4 * (a - 1) + 3]), 0 === t ? (o = a) : (c = a), (a = (o + c) >> 1);
    ...
    function t(e, t) {
        return (
            (this.save = __bind(this.save, this)),
                ...
                (this.textarea = $(e)),
                0 === this.textarea.length
                    ? console.log("Aucun élément ne correspond à ce selecteuir")
                    : ((this.options = {
                        ...
                        (this.scrolling = !1),
                        (this.isMarkdownMoving = !1),
                        (this.isPreviewMoving = !1),
                    void 0 !== t && $.extend(this.options, t),
                        (this.canExit = !0),
                        (this.element = $(
                            '<div class="mdeditor">\n  <div class="mdeditor_toolbar"></div>\n  <div class="mdeditor_body">\n    <section class="mdeditor_markdown"><div class="mdeditor_scroll mdeditor_markdown_scroll"></div></section>\n    <section class="mdeditor_preview"><div class="mdeditor_scroll mdeditor_preview_scroll"><div class="mdeditor_render"></div></div></section>\n  </div>\n  <div class="mdeditor_modal"><div class="mdeditor_drop"></div></div>\n</div>'
                        )),
                    ...
                    this.options.preview || this.element.addClass("has-no-preview"),
                        $(".mdeditor_markdown .mdeditor_scroll", this.element).append(this.textarea),
                        (this.editor = CodeMirror.fromTextArea(this.textarea[0], { mode: "markdown", tabMode: "indent", theme: "neo", lineWrapping: !0, viewportMargin: 1 / 0 })),
                        this.updatePreview(),
                        this._buildToolbar(),
                        this._buildDropzone(),
                        this._bindEvents(),
    ...
    return (
        (t.prototype.updatePreview = function () {
            ...
            (t.prototype.link = function (e) {
                ...
                return (
                    void 0 !== e && e.preventDefault(),
                        ...
                        (t = this.editor.doc.getCursor()),
                        this.editor.doc.setCursor({ line: t.line, ch: t.ch - 1 }),
                        this.editor.focus()
                );
            }),
            ...
            (t.prototype.save = function (e) {
                return (
                    void 0 !== e && e.preventDefault,
                        canExit
                            ? !0
                            : $.ajax({ dataType: "json", url: this.form.attr("action"), data: this.form.serialize(), type: this.form.attr("method") })
                                .done(
                                    (function (e) {
                                        return function () {
                    ...
                    this.editor.on(
                        ...
                        $(document).keydown(
                            (function (t) {
                                return function (e) {
                                    return (
                                        (e.ctrlKey || e.metaKey) && (83 === e.which ? t.save(e) : 66 === e.which ? t.bold(e) : 73 === e.which ? t.italic(e) : 76 === e.which && t.link(e)),
                                            27 === e.which && t.element.hasClass("is-fullscreen") ? fullscreen(e) : void 0
                                    );
                                };
                            })(this)
                        ),
            ...
            (t.prototype._syncScroll = _.throttle(function () {
                var e, t, r;
                return this.preview.is(":visible") && 0 !== this.markdownSections.length && 0 !== this.previewSections.length
                    ? ((t = this.markdownScroll.scrollTop()),
                        (r = this.previewScroll.scrollTop()),
                        (e = 0),
                        "markdown" === this.scrolling
                            ? Math.abs(t - this.lastMarkdownScrollTop) <= 9
                            ? !1
                            : ((this.scrolling = !1),
                                (this.lastMarkdownScrollTop = t),
                                (e = this._scrollTop(t, this.markdownSections, this.previewSections)),
                                Math.abs(e - r) <= 9
                                    ? ((this.lastPreviewScrollTop = r), !1)
                                    : ((this.isPreviewMoving = !0),
                                        this.previewScroll.stop().animate(
                                            { scrollTop: e },
                                            100,
                                            (function (e) {
                                                return function () {
            ...
            (t.prototype._scrollTop = function (e, t, r) {
                var n, i, o, l;
                return (
                    (l = 0),
                        (o = _.find(t, function (t, r) {
            ...
            (t.prototype._buildToolbar = function () {
                return (
                    $('<button class="mdeditor_bold">b</button>').appendTo(this.toolbar).click(this.bold),
                        ...
                        $('<button class="mdeditor_fullscreen">f</button>').appendTo(this.toolbar).click(this.fullscreen)
                );
            }),
                            ...
                            return (
                                (i = this),
                                    (n = function (t) {
                                        ...
                                        return (
                                            (n = $(t.previewElement)),
                                                n.append('<a class="dz-insert" href="#">' + r.labelInsert + "</a>"),
                                                $(".dz-insert", n).click(function (r) {
                                                    var n;
                                                    return r.preventDefault(), r.stopPropagation(), e.doc.replaceSelection("![](" + t.url + ")"), (n = e.doc.getCursor()), e.doc.setCursor({ line: n.line, ch: 2 }), e.focus(), $(".mdeditor_modal").hide();
                                                })
                                        );
                                    }),
                                    ...
                                    this.on("removedfile", function (e) {
                                        return $.ajax({ url: r.uploader + "/" + e.id, method: "DELETE" })
                                            .done(function () {})
                                            .fail(function (e) {
            ...
            (t.prototype._setSections = _.debounce(function () {
                ...
                (this.markdownSections = []),
                    ...
                    (e = null),
                    (t = null),
                    $(".CodeMirror-code .cm-header", this.element).each(
                        (function (t) {
                            return function (r, n) {
                                var i;
                                return null === e ? ((e = 0), void 0) : ((i = $(n).offset().top + t.markdownScroll.scrollTop()), t.markdownSections.push({ startOffset: e, endOffset: i, height: i - e }), (e = i), void 0);
                            };
                        })(this)
                    ),
                    this.markdownSections.push({ startOffset: e, endOffset: this.markdownScroll[0].scrollHeight, height: this.markdownScroll[0].scrollHeight - e }),
                    this.preview.find("h1, h2, h3, h4, h5").each(
                        (function (e) {
                            return function (r, n) {
                                var i;
                                return null === t ? ((t = 0), void 0) : ((i = $(n).offset().top + e.previewScroll.scrollTop()), e.previewSections.push({ startOffset: t, endOffset: i, height: i - t }), (t = i), void 0);
                            };
                        })(this)
                    ),
                    this.previewSections.push({ startOffset: t, endOffset: this.previewScroll[0].scrollHeight, height: this.previewScroll[0].scrollHeight - t }),
